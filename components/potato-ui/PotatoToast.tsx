...
export default function PotatoToast({ type, title, description }: ToastProps) {
    return (
        <ShadowedView
            ...
            className="{}-[shadowColor]:color-black bg-background-0 border-background-100 border min-h-[50px] rounded-[25px] pl-3 pr-[1.125rem] py-[0.8125rem] flex-row gap-3 mx-6 my-2 max-w-[400px]"
        >
            {type === "success" && (
